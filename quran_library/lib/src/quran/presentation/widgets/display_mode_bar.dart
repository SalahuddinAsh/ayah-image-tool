          ...
          child: Material(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  // Dark/light mode toggle (shown only when onThemeToggle is provided)
                  if (s.onThemeToggle != null) ...[
                    Container(
                      decoration: BoxDecoration(
                        color: Colors.transparent,
                        borderRadius:
                      ...
                      child: IconButton(
                        icon: Icon(
                          ...
                          color: style?.unselectedIconColor ??
                              Colors.grey.shade600,
                        ),
                        tooltip: (s.isDarkMode ?? false) ? 'وضع نهاري' : 'وضع ليلي',
                        onPressed: s.onThemeToggle,
                      ),
                    ),
