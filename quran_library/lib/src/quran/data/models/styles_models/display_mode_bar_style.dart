...
class DisplayModeBarStyle {
  ...
  /// اختياري: callback يُستدعى عند الضغط على زر تبديل الوضع الليلي/النهاري
  final VoidCallback? onThemeToggle;

  /// اختياري: القيمة الحالية للوضع الليلي (true = داكن)
  ...
  DisplayModeBarStyle copyWith({
    ...
    return DisplayModeBarStyle(
      ...
      onThemeToggle: onThemeToggle ?? this.onThemeToggle,
